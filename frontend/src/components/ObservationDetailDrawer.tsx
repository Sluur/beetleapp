  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute right-0 top-0 h-full w-full md:w-[540px] bg-white border-l-2 border-slate-200 shadow-2xl flex flex-col">
        ...
        <div className="px-6 py-5 border-b-2 border-slate-200 bg-linear-to-r from-blue-50 to-indigo-50 flex items-center gap-3">
          <h2 className="text-2xl font-bold flex-1 bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            Detalle de observación
          </h2>
          <button
            onClick={onClose}
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl
                     text-slate-600 hover:bg-linear-to-r hover:from-blue-500 hover:to-indigo-500 
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-linear-to-br from-slate-50/50 to-blue-50/30">
          {loading && (
              ...
              {!edit ? (
                <>
                  {item.photo_url ? (
                    ...
                    <div className="w-full h-52 rounded-2xl bg-linear-to-br from-slate-100 to-slate-200 border-2 border-slate-200 grid place-items-center">
                  ...
                  {item.inference && (
                    <div className="p-5 rounded-2xl bg-linear-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 space-y-3">
